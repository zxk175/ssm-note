package com.zxk175.ssm_note.controller;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.github.pagehelper.StringUtil;
import com.zxk175.ssm_note.model.BaseResult;
import com.zxk175.ssm_note.model.Pages;
import com.zxk175.ssm_note.pojo.User;
import com.zxk175.ssm_note.pojo.UserExample;
import com.zxk175.ssm_note.pojo.UserExample.Criteria;
...
public class UserController {
    ...
    public BaseResult apiInitTable(@PathVariable Integer num) {
        ...
        String slat = "dgfedsuhi98u8we5r35jn4237y6&*^&*^^5765EW532LKJ";
        String msg = "";
        ...
        for (int i = 1; i <= num; i++) {
            ...
            x = x + 100000;
            String pwd = x + "/" + slat;
            u.setUserPwd(DigestUtils.md5DigestAsHex(pwd.getBytes()));
