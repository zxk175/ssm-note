...
<head>
    ...
    <!-- bootstrap-table -->
    <script type="text/javascript" src="../library/bootstrap-table/1.9.1/bootstrap-table.js"></script>
    <script type="text/javascript" src="../library/bootstrap-table/1.9.1/bootstrap-table-locale-all.js"></script>
    <link rel="stylesheet" type="text/css" href="../library/bootstrap-table/1.9.1/bootstrap-table.css"/>
    <!--[if lt IE 9]>
    <script src="../library/bootstrap/plugins/ie/html5shiv.js"></script>
    <script src="../library/bootstrap/plugins/ie/respond.js"></script>
    <![endif]-->
    <!--[if lt IE 8]>
    <script src="../library/bootstrap/plugins/ie/json2.js"></script>
    <![endif]-->
    <!-- font-awesome -->
    <link rel="stylesheet" type="text/css" href="../library/fontAwesome/css/font-awesome.min.css" media="all"/>
    <!-- layer -->
    <script type="text/javascript" src="../library/layer/layer.js"></script>
    <!-- laydate -->
    <link rel="stylesheet" type="text/css" href="../library/laydate/need/laydate.css"/>
    <script type="text/javascript" src="../library/laydate/laydate.js"></script>
    <!-- base -->
